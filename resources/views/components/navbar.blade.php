...
>
    <nav
        :class="{ 'bg-white shadow-lg': scrolled, 'bg-transparent': !scrolled }"
        class="flex items-center justify-between p-6 lg:px-8 fixed inset-x-0 top-0 z-50"
        aria-label="Global"
    >
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                <span class="sr-only">Ilham Maulana</span>
                <p class="text-xl font-bold">IlhamMaul</p>
                <!-- <img
                    class="h-8 w-auto"
                ...
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <x-nav-link-mobile href="/" :active="request()->is('/')"
                            >Home</x-nav-link-mobile
                        >
                        <x-nav-link-mobile
                            href="about"
                            :active="request()->is('about')"
                            >About</x-nav-link-mobile
                        >
                        <x-nav-link-mobile
                            href="projects "
                            :active="request()->is('projects')"
                            >Projects</x-nav-link-mobile
                        >
                        <x-nav-link-mobile
                            href="posts"
                            :active="request()->is('posts')"
                            >Blog</x-nav-link-mobile
                        >
                        <x-nav-link-mobile
                            href="contact"
                            :active="request()->is('contact')"
                            >Contact</x-nav-link-mobile
                        >
                    </div>
                    <div class="py-6">
                        <a
